...
<div class="flex w-full">
    ...
    <div class="w-full flex justify-center">
        <form method="POST" action="<?= route_to('login') ?>" class="py-8 rounded-3xl shadow-2xl flex flex-col 2xl:w-2/3 xl:w-3/4 lg:w-5/6 md:w-7/12 sm:w-2/3 w-full lg:mx-0 mx-5">
            <?= csrf_field(); ?>
