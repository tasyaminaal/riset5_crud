...
<div class="lg:mx-36 mx-5 lg:mt-12 md:mt-16 mt-12 mb-8 w-full">
    ...
    <a href="/developer/buatProyek">
        <div
            class="flex justify-center md:w-44 w-28 md:px-2 md:py-2 px-1 py-1 lg:mt-12 mt-4 mb-8 rounded-lg border-gray shadow-lg tracking-wider cursor-pointer hover:bg-gray-100">
            <div class="flex items-center justify-center">
                <svg class="text-secondary md:w-8 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                    fill="currentColor">
    ...
    <div class="w-11/12 mx-auto mb-4 rounded-b-xl shadow-xl hidden opacity-0 duration-500 transition-all">
        <div class="flex justify-start text-sm">
            ...
            <a data-id="<?php echo $data['id'] ?>"
                class="delete-project py-1 w-20 text-center mr-1 text-red-500 font-semibold transition-all cursor-pointer outline-none border-none bg-transparent hover:text-red-700">CANCEL</a>
        </div>
