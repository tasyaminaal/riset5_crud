...
<body>
    ...
    <!-- HEADER -->
    <div class="navbar w-full fixed z-10 bg-cover bg-no-repeat bg-left transition duration-700 ease-out" style="background-image: url(/img/components/bgHeader.png)" id="navbar">
        <header>
