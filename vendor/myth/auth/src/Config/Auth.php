...
class Auth extends BaseConfig
{
    ...
    //
    public $defaultUserGroup = 'Alumni';
    ...
    public $views = [
        ...
        'reset' => '\App\Views\login\resetpass',
        'register' => '\App\Views\Admin\users\insert',
    ...
    public $personalFields = ['fullname', 'nim'];
    ...
    public $userActivators = [
        'Myth\Auth\Authentication\Activators\EmailActivator' => [
            'fromEmail' => 'masihbelajar0004@gmail.com',
            'fromName' => 'Riset 5',
        ],
    ];
