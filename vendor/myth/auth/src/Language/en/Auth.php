...
return [
    ...
    'activationSuccess'         => 'Registration is successful. The system will confirm to the user concerned to confirm the account by clicking the activation link in the email that was sent.', // translate
